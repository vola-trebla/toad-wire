    ...
    return (
        ...
        >
            <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center' }}>
                ...
                >
                    Las noticias cripto importantes aparecen primero en inglés. El sapo las traduce,
                    las resume y las envía a tu Telegram en español rioplatense — sin tecnicismos
                    innecesarios, sin hype, sin drama.
                    <br />
                    <br />
