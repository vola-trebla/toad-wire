                        ...
                        {(Object.keys(MOODS) as Mood[]).map(m => (
                            <button
                                ...
                                style={{
                                    ...
                                    background: mood === m
                                        ? m === 'bearish' ? 'rgba(255,59,59,0.15)' : 'rgba(45,255,110,0.15)'
                                        : 'transparent',
                                    color: mood === m
                                        ? m === 'bearish' ? 'var(--red)' : 'var(--green)'
                                        : 'var(--text-muted)',
                                }}
                            >
            ...
            <section style={{
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        Las noticias cripto importantes aparecen primero en inglés.
                        El sapo las traduce, las resume y las envía a tu Telegram
                        en español rioplatense — sin tecnicismos innecesarios,
                        sin hype, sin drama.
                        <br /><br />
